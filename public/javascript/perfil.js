...
function inicialitzarEvents() {
    document.perfil.addEventListener("submit", formValidatorEvent);
    document['perfil']['username'].addEventListener("change", validaElementEvent);
    document['perfil']['confPassword'].addEventListener("change", validaElementEvent);
}
...
function formValidator() {
    ...
    var username = document['perfil']['username'];
    var confPassword = document['perfil']['confPassword'];
...
function notSamePassword(elem, helperMsg) {
    var resultat = (elem.value == document['perfil']['password'].value);
    tractarError(elem, resultat, helperMsg);
    return resultat;
}
